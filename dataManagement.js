...
async function loadFullData() {
  ...
  if(window.global.subject == "Elliot") {
    ...
    window.global.fullArtists = await loadJson("datasets/tracks/artists_elodie.json")
    window.global.fullAlbums  = await loadJson("datasets/tracks/albums_elodie.json")
  } else {
